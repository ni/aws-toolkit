...
<Project Type="Project" LVVersion="15008000">
	...
	<Property Name="NI.Project.Description" Type="Str">Contains examples illustrating the use of the IoT VIs in the NI Cloud Toolkit for AWS.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="AWS IoT Button - Publish to SNS Topic.vi" Type="VI" URL="../AWS IoT Button - Publish to SNS Topic.vi"/>
		<Item Name="AWS IoT Button - Send SQS Message.vi" Type="VI" URL="../AWS IoT Button - Send SQS Message.vi"/>
		<Item Name="AWS IoT Button - Upload to S3 Bucket.vi" Type="VI" URL="../AWS IoT Button - Upload to S3 Bucket.vi"/>
